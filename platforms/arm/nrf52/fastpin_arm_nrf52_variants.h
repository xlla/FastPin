...
// See https://github.com/sandeepmistry/arduino-nRF5/blob/master/boards.txt
    ...
    _FL_DEFPIN( 7,  11, 0); // D7  is P0.xx (COLR2)n
    ...
    _FL_DEFPIN(16,  2, 1); // D16 is P1.xx (GPIO3)
    //_FL_DEFPIN(17, 10, 0); // D17 is P0.xx (NFC2, Not connected)
    // _FL_DEFPIN(18, 11, 0); // D18 is P0.xx (RXD)
    _FL_DEFPIN(19, 26, 0); // D19 is P0.xx (I2C SCL)
    _FL_DEFPIN(20, 0, 1); // D20 is P1.xx (I2C SDA)
    _FL_DEFPIN(21, 21, 0); // D21 is P0.xx (ROW1)
    _FL_DEFPIN(22, 22, 0); // D22 is P0.xx (ROW2)
    _FL_DEFPIN(23, 15, 0); // D23 is P0.xx (ROW3)
    _FL_DEFPIN(24, 24, 0); // D24 is P0.xx (ROW4)
    _FL_DEFPIN(25, 19, 0); // D25 is P0.xx (ROW5)
    _FL_DEFPIN(26, 4, 1); // D26 is P1.xx LOGO (touch sensor)
    _FL_DEFPIN(27, 0, 0); // D27 is P0.xx SPEAKER (Note: Must use synthesized LF clock to make this pin available)
    _FL_DEFPIN(28, 20, 0); // D28 is P0.xx RUN_MIC
    _FL_DEFPIN(29, 5, 0); // D29 is P0.xx (A6, MIC_IN)
    _FL_DEFPIN(30, 16, 0); // D30 is P0.xx (I2C_INT_SDA)
    _FL_DEFPIN(31, 8, 0); // D31 is P0.21 (I2C_INT_SCL)
#endif // defined(ARDUINO_GENERIC)
